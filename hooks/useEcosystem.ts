...
export const useEcosystem = (
  radio: any,
  setModalOpen: ReturnType<typeof useModals>['setModalOpen'],
  navigateTo: ReturnType<typeof useNavigation>['navigateTo'],
  setManagementInitialTab: (tab: ManagementTab) => void,
  ...
  const handleEcosystemNavigation = useCallback((action: string) => {
    ...
    if (type === "open") {
      switch (target) {
        ...
        case "notifications":
          setManagementInitialTab("notifications");
          setModalOpen("managementCenter", true);
          break;
    ...
    if (type === "navigate") {
      switch (target) {
        ...
        case "profile":
          setManagementInitialTab("profile");
          setModalOpen("managementCenter", true);
          break;
        ...
        case "testimonies":
          ...
          break;
        case "radio": navigateTo("radio"); break;
        ...
        case "imagination-studio": navigateTo("imagination-studio"); break;
        case "song-creator": navigateTo("song-creator"); break;
  ...
  }, [radio, setModalOpen, navigateTo, setManagementInitialTab, setYoutubeInitialSource]);
